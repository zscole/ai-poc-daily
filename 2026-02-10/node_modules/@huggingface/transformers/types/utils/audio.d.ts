 ...
 */
export function mel_filter_bank(num_frequency_bins: number, num_mel_filters: number, min_frequency: number, max_frequency: number, sampling_rate: number, norm?: string | null, mel_scale?: keyof typeof MEL_TO_HERTZ_MAPPING, triangularize_in_mel_space?: boolean): number[][];
/**
...
export class RawAudio {
     ...
     */
    constructor(audio: Float32Array | Float32Array[], sampling_rate: number);
    audio: Float32Array<ArrayBufferLike> | Float32Array<ArrayBufferLike>[];
...
declare namespace MEL_TO_HERTZ_MAPPING {
    function htk(mels: number): number;
    function kaldi(mels: number): number;
    function slaney(mels: number, min_log_hertz?: number, min_log_mel?: number, logstep?: number): number;
}
