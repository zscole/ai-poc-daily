...
export class SamImageProcessor extends ImageProcessor {
     ...
     * @returns {Tensor}
     */
    reshape_input_points(input_points: any, original_sizes: import("../../image_processors_utils.js").HeightWidth[], reshaped_input_sizes: import("../../image_processors_utils.js").HeightWidth[], is_bounding_box?: boolean): Tensor;
    /**
     *
